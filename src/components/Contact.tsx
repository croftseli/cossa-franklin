        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="animate-slide-up">
              <h2 className="text-3xl font-serif font-bold text-brown-800 mb-8">
                Get Your Quote
              </h2>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-brown-300 rounded-lg focus:ring-2 focus:ring-brown-500 focus:border-transparent transition-all duration-200"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 border border-brown-300 rounded-lg focus:ring-2 focus:ring-brown-500 focus:border-transparent transition-all duration-200 resize-none"
                ...
                <button
                  ...
                  className="w-full bg-brown-700 text-cream px-8 py-4 rounded-lg font-semibold hover:bg-brown-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2"
                >
                  {isSubmitting ? (
                    <span>Sending...</span>
                  ) : (
            ...
            <div className="animate-scale-in">
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-brown-800 mb-2">Location</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-brown-800 mb-2">Phone</h3>
                    <p className="text-brown-600">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-brown-800 mb-2">Email</h3>
                    <p className="text-brown-600">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-brown-800 mb-2">Response Time</h3>
                    <p className="text-brown-600">
              ...
              {/* Additional Info */}
              <div className="mt-12 bg-gradient-to-br from-brown-50 to-accent-50 rounded-2xl p-8 border border-brown-100">
