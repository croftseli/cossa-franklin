...
const Portfolio = () => {
  ...
  const portfolioItems = [
    ...
    {
      id: 3,
      title: 'Custom Sports Team Logo',
      category: 'Sports',
      image: 'https://images.pexels.com/photos/8844288/pexels-photo-8844288.jpeg?auto=compress&cs=tinysrgb&w=800',
      description: 'Team logo with intricate detail work for championship jackets.',
    },
    {
      id: 4,
