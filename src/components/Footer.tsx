...
const Footer = () => {
  return (
    <footer className="bg-brown-900 text-cream">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div>
                <h3 className="text-2xl font-serif font-bold">Cossa</h3>
                <p className="text-sm text-brown-300">Custom Embroidery</p>
              </div>
            </div>
            <p className="text-brown-200 leading-relaxed mb-6 max-w-md">
          ...
          <div>
            ...
            <nav className="space-y-3">
              <Link 
                to="/" 
                className="block text-brown-200 hover:text-cream transition-colors duration-200"
              >
                Home
              </Link>
              <Link 
